...
parameter2=("4features") # input features
...
srun python /home/qizhou/3paper/2AGU/1featureIMP/1Ensemble_modelClassification20231211_6features.py --input_station  "$current_parameter1" --bl_or_rf "$current_parameter2" --RF_or_XGB "$current_parameter3" --classificationORregression "classification"
