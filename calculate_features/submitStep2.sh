...
srun python /home/qizhou/1projects/dataForML/out60/2cal_allBL_RF_network.py --input_year "$current_parameter1" --input_component "$current_parameter2" --input_window_size 60
