...
srun python /home/qizhou/1projects/dataForML/out60/1cal_allBL_RF.py --year "$current_parameters1" --input_station "$current_parameters2" --input_component "$current_parameters3"
