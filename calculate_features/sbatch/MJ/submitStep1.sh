...
#SBATCH --array=1-12              # job array id, !!!! all combination of parameters1-3
#SBATCH --mem-per-cpu=32G		       # Memory Request (per CPU; can use on GLIC)

#SBATCH --chdir=/home/qizhou/3paper/0seismic_feature/sbatch/MJ/logs # set working dir
...
parameters1=(2022)
parameters2=("EG1" "EG2" "FTB1" "FTB2")
parameters3=($(seq 230 232)) # 3 = 232 - 230 + 1
