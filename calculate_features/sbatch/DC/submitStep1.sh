...
#SBATCH --array=1-591              # job array id, !!!! all combination of parameters1-3
#SBATCH --mem-per-cpu=32G		   # Memory Request (per CPU; can use on GLIC)

#SBATCH --chdir=/home/qizhou/3paper/0seismic_feature/sbatch/DC/logs # set working dir
...
parameters1=(2024)
parameters2=("BL7" "BL8" "BL9")
parameters3=($(seq 97 293)) # 197 = 293 - 97 + 1
