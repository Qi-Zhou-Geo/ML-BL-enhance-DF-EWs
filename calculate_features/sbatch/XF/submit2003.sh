...
#SBATCH --array=1-9              # job array id, !!!! all combination of parameters1-3
#SBATCH --mem-per-cpu=32G              # Memory Request (per CPU; can use on GLIC)

#SBATCH --chdir=/home/qizhou/3paper/0seismic_feature/sbatch/XF # set working dir
...
parameters1=(2003)
parameters2=("H0390")
parameters3=($(seq 221 229)) # 9 = 229 - 221 + 1
