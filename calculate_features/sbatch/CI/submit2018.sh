...
#SBATCH --array=1-31              # job array id, !!!! all combination of parameters1-3
#SBATCH --mem-per-cpu=16G              # Memory Request (per CPU; can use on GLIC)

#SBATCH --chdir=/home/qizhou/3paper/0seismic_feature/sbatch/CI # set working dir
...
parameters1=(2018)
parameters2=("QAD")
parameters3=($(seq 1 31)) # 209 = 364 - 156 + 1
