...
#SBATCH --array=1-2                # job array id, !!!! all combination of parameters1-3
#SBATCH --mem-per-cpu=32G		       # Memory Request (per CPU; can use on GLIC)

#SBATCH --chdir=/home/qizhou/3paper/0seismic_feature/sbatch/MR/logs # set working dir
...
parameters1=(2007)
parameters2=("TRAN")
parameters3=($(seq 76 77)) # 2 = 76 - 77 + 1
