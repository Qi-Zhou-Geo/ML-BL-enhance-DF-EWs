...
#SBATCH --chdir=/home/qizhou/3paper/2AGU_revise/ML-BL-enhance-DF-EWs/plotting/dual_testing_pro # set working dir
#SBATCH --output=2022/logs/out_%A_%a_%x.txt  # Standard Output Log File
#SBATCH --error=2022/logs/err_%A_%a_%x.txt   # Standard Error Log File
