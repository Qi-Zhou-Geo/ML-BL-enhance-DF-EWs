...
#SBATCH --output=model_dual_test_1A/logs/out_%A_%a_%x.txt  # Standard Output Log File
#SBATCH --error=model_dual_test_1A/logs/err_%A_%a_%x.txt   # Standard Error Log File
