...
parameters2=("Random_Forest") # input model
parameters3=("C") # input features

# Create parameters4 with integers from 1 to 80 excluding [34, 26, 52]
exclude_list=(72 73 18 53 13 76 45 63 16 62 32 66 77 46 20 75 74 64 59 27 1 65 44 54 30 7 61 31 11 12 19 6 43 4 38 3 10 0 8 5 15 17 68 25 21 42 2 79 14 49 52 33 29 60 26 48 39 51 9 50 34 36 40 69 78 28 41 58 57 37)  # You can leave this empty or define the values to exclude
parameters4=()
