...
def load_A_or_B_Features(STATION, featureTYPE, component="EHZ", dataYear="2017_1-2020"):
    '''----------
...
def load_C_Features(STATION, component="EHZ", dataYear="2017_1-2020"):
    '''----------
    STATION: load data from which station
    -------'''
...
def load_D_Features(STATION, component="EHZ", dataYear="2017_1-2020"):
    '''----------
    STATION: load data from which station
    -------'''
